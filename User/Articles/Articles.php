            ...
            try {
                ...
                if ( count( $articles ) === 0 ) {
                    ...
                    foreach ( $articles as $article ) {
                        ...
                        echo "<div class = 'mt-4'>";
                        echo "<h2 class = 'text-xl font-bold text-slate-800 mb-2 umderline'>" . htmlspecialchars( $article[ 'title' ] ) . '</h2>';
                        ...
                        echo "<a href='edit.php?id=" . $article['id'] . "' class='px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600 text-sm' onclick=\"return confirm('Are you sure you want to delete this article?');\"><i class='fa fa-trash'></i> Delete</a>";
                        echo "</div>";
                        echo "</div>";
                    }
                }
